$(function(){
      ...
      //=============调用：(假数据)=============
       ...
       //图表：(具体场景)
          ...
          $(".button2 li").click(function(){
                ...
                if(index==1){
                    JTzhe1('KPI',zheX,JTzhe1Ydata2);
                }else if(index==2){
                    JTzhe1('KQI',zheX,JTzhe1Ydata3);
                }else if(index==3){
                    JTzhe1('容量',zheX,JTzhe1Ydata4);
                }else{
                    JTzhe1('告警',zheX,JTzhe1Ydata1);
                }
  ...
  //         zhu(zhuX,zhuY);
  //         zhu2(zhu2X,zhu2Y1,zhu2Y2);
  //         zhe(zheX,zheY1,zheY2,zheY3);
  //     }
  //     setInterval(jishiqi,10000);
});